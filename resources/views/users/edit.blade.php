            ...
            <div class="card shadow-premium border-0 overflow-hidden card-hover">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-5 border-bottom border-light pb-4">
                        ...
                        <h3 class="fw-extrabold text-dark mb-1" style="font-family: 'Outfit', sans-serif;">Edit Pengguna</h3>
                        <p class="text-muted small mb-0">Ubah detail profil staf, perbarui penugasan meja loket, atau setel ulang password.</p>
                    </div>
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div id="loket-wrapper" class="mb-4" style="{{ $currentRole == 'petugas' ? '' : 'display:none;' }}">
                        ...
                        <div class="border-top border-light my-5 pt-4">
                            <span class="text-danger fw-extrabold mb-3 d-flex align-items-center gap-2 small" style="font-family: 'Outfit', sans-serif; letter-spacing: 0.5px;">
                                <i class="fas fa-key text-danger"></i> UBAH PASSWORD (OPSIONAL)
                            </span>
                            <p class="text-muted small mb-4">Kosongkan kolom password di bawah apabila Anda tidak berencana untuk mengubah password pengguna.</p>
                            
                            {{-- Password --}}
                            <div class="mb-4">
                                <label for="password" class="form-label fw-bold text-secondary small" style="font-family: 'Outfit', sans-serif; letter-spacing: 0.5px;">PASSWORD BARU</label>
                                <div class="input-group">
                            ...
                            {{-- Konfirmasi Password --}}
                            <div class="mb-5">
                                <label for="password_confirmation" class="form-label fw-bold text-secondary small" style="font-family: 'Outfit', sans-serif; letter-spacing: 0.5px;">KONFIRMASI PASSWORD BARU</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-0 text-muted"><i class="fas fa-lock"></i></span>
                                    <input 
                                        type="password" 
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary py-3 rounded-pill fw-bold scale-hover border-0 shadow-premium" style="background: linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%);">
                                <i class="fas fa-save me-2"></i> SIMPAN PERUBAHAN PENGGUNA
                            </button>
                        </div>
                    </form>
                </div>
